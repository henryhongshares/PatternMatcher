...
from binanceClient.client import Client
...
binance_api_key = 'EH2Ey120jHdPmTKmspbcp4JAvcPFHE0ZxOsp4fYZ53BOaGWNI7qTwDiK5XYr6czj'    #Enter your own API-key here
binance_api_secret = '8tTDXJIwpg8MFgKpTFCf1Ifz1sgjmJ8kuNemxcTEWiCXPlV5qkYmi24vxzHR6Qo1' #Enter your own API-secret here
...
get_all_binanceFutures('BTCUSDT', '1m', save = True)